    ...
    try:
        ...
        while True:
            ...
            if jobQueue.empty() != True:
                ...
                dataFromQuote = commandControl(data, redClient)
...
def commandControl(data, redClient):
    dl = data.split(',')
...
if __name__ == '__main__':
    ...
    recvFromHttp(redClient)
    # for i in range(10):
    #     th = threading.Thread(target = recvFromHttp, arg(sSocket,redClient,))
    #     th.start()
