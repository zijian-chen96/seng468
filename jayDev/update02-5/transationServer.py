        ...
        while True:
            ...
            if data:
                ...
                if dataList2[1] == "SET_BUY_AMOUNT":
                    ...
                    dataFromQuote = "Trigger is hit running..."
                    #return "Trigger is hit running..."

                elif dataList2[1] == "SET_SELL_AMOUNT":
...
def deleteTriggerFromDB(username, stockname, command):
    deleteFormula = "DELETE FROM triggers WHERE username = %s AND stockname = %s AND command = %s LIMIT 1"
