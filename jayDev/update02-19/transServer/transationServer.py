...
def commandControl(data, cSocket):
    ...
    if dataList[1] == "ADD":
        ...
        if result == 1 and diName in buyTriggerQueue and buyTriggerQueue.get(diName).is_alive():
        ...
        diName = dataList[2]+'-'+dataList[3]
        if result == 1 and diName in sellTriggerQueue and sellTriggerQueue.get(diName).is_alive():
