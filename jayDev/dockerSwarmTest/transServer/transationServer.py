...
def sendJob():
    while True:
        if finQueue.empty() != True:
            ...
            httpSocket.connect(('192.168.0.34',52000))
            data = finQueue.get()
...
def recvFromHttp(mydb, mycursor, redClient):
...
def commandControl(mydb, mycursor, data, redClient):
    ...
    if dataList[1] == "ADD":
        ...
        if currFunds >= Decimal(dataList[4]):
            ...
            return dataList[0] + ' ' + "User Funds Not Enough!"
        ...
        if buyDataFromRedis == [] or stockname == None:
            return dataList[0] + ' ' + "ERROR BUY COMMAND NOT FIND!"
        ...
        if stockname != None or buyDataFromRedis != []:
            ...
            return dataList[0] + ' ' + "BUY Command has been caneled!"
        else:
            #trans,command,username,server,types:userCommand-cancelBuy(4)
            #dataToAudit = ",".join([data,"CLT2","four"])
            dataToAudit = {'trans': dataList[0], 'command': dataList[1], 'username': dataList[2], 'server': "CLT2", 'types': 'four'}
            ...
            return dataList[0] + ' ' + "NO BUY COMMAN IN DB"
        ...
        if stockAmount > 0:
            ...
            if quoteDataFromRedis != []:
                ...
                if ownStockAmount < Decimal(dataList[4]):
                    return dataList[0] + ' ' + "User money is not enough!"
            ...
            return dataList[0] + ' ' + "User dose not own the stocks!"
        ...
        if quoteDataFromRedis != []:
            ...
            if ownStockAmount >= Decimal(sellDataFromRedis[2]):
                ...
                return dataList[0] + ' ' + "ERROR USER OWN AMOUNT NOT ENOUGH!"
        ...
        if stockname != None or sellDataFromRedis != []:
            ...
            return dataList[0] + ' ' + "SELL Command has been caneled"
        else:
            #trans,command,username,server,types:userCommand-cancelBuy(4)
            #dataToAudit = ",".join([data,"CLT2","four"])
            dataToAudit = {'trans': dataList[0], 'command': dataList[1], 'username': dataList[2], 'server': "CLT2", 'types': 'four'}
            ...
            return dataList[0] + ' ' + "NO SELL COMMAND IN DB"
        ...
        return dataList[0] + ' ' + (result + "the end")
        ...
        return dataList[0] + ' ' + "Trigger is hit running..."
        ...
        if btriDataFromRedis != None and diName in buyTriggerQueue:
            ...
            return dataList[0] + ' ' + "CANCEL SET BUY!"
        else:
            #trans,command,username,stockname,server,types:userCommand-cancelSetBuy(5)
            #dataToAudit = ",".join([data,"CLT3","five"])
            dataToAudit = {'trans': dataList[0], 'command': dataList[1], 'username': dataList[2], 'stockname': dataList[3], 'server': "CLT3", 'types': 'five'}
            ...
            return dataList[0] + ' ' + "NO BUY TRIGGER"
        ...
        return dataList[0] + ' ' + "SET BUY TRIGGER!"
        ...
        return dataList[0] + ' ' + "SET SELL TRIGGER!"
        ...
        if striDataFromRedis != None and diName in sellTriggerQueue:
            ...
            return dataList[0] + ' ' + "CANCEL SET SELL!"
        else:
            #trans,command,username,stockname,server,types:userCommand-cancelSetSell(5)
            #dataToAudit = ",".join([data,"CLT3","five"])
            dataToAudit = {'trans': dataList[0], 'command': dataList[1], 'username': dataList[2], 'stockname': dataList[3], 'server': "CLT3", 'types': 'five'}
            ...
            return dataList[0] + ' ' + "NO SELL TRIGGER"
...
if __name__ == '__main__':
    ...
    recvFromHttp(mydb, mycursor, redClient)
