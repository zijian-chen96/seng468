...
mycursor.execute("CREATE TABLE bslogs (username VARCHAR(255), transnumber INTEGER(10), command VARCHAR(255), stockname VARCHAR(255), amount DECIMAL(10,2), times BIGINT(15))")
